use crate::graphql::{graphql_api, graphql_playground, ProductsMutation, ProductsQuery, ProductsSchema};
use crate::repository::ProductsRepository;
use crate::routes::{create_product, get_product_by_sku, list_products, up};
...
pub fn run(
    ...
    let graphql_schema: ProductsSchema =
        Schema::build(ProductsQuery, ProductsMutation, EmptySubscription)
